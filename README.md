...
Es un archivo que le indica a github qué archivos innecesarios debería ignorar al momento de actualizar un repositorio con archivos locales. El archivo indica que se ignoren los archivos según su contenido. Esta práctica sirve para mantener el repositorio limpio y mejora la seguridad.
